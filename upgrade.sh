...
cp inretensys-backend/dist/InRetEnsys-0.2a5-py3-none-any.whl inretensys-fastapi/requirements
cp inretensys-backend/dist/InRetEnsys-0.2a5-py3-none-any.whl inretensys-gui/app/requirements
